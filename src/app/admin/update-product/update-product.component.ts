...
@Component({
  ...
  styleUrls: ['./update-product.component.css', '../../../assets/admin/css/paper-dashboard.css?v=2.0.1', '../../../assets/admin/demo/demo.css', '../../../assets/admin/css/bootstrap.min.css',],
...
export class UpdateProductComponent implements OnInit {
  ...
  constructor(public productService: ProductService, private router: Router, private categoryProductService: CategoryProductService, public toastr: ToastrService, private fb: FormBuilder,  private route: ActivatedRoute) { }
